...
%% optimization
func = @(x) cost_function3D(x,alp,bet,gam,g,rw,Dc,Dv,thetadf);
...
%% visualize results
[t,phi,phid,times,THETA,tau] = get_trajs3D(x,alp,bet,gam,g,rw,Dc,Dv);
...
render3D([THETA(:,1) phival(:,1)],times,rw,xw,yw);
